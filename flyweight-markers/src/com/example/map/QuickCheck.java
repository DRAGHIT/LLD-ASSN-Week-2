...
/**
 * Quick validation: - counts unique style object references used by markers.
 *
 * Starter should report a large number (close to marker count). After Flyweight
 * refactor, it should report a small number (bounded by unique combinations of
